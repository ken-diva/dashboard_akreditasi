    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      $('#edit-data-modal').on('show.bs.modal', function(event) {
        ...
        $.ajax({
          ...
          success: function(response) {
            // Populate modal with data
            $('#faculty_name-modal2').val(response.faculty_name);
            $('#studyprogram_name-modal2').val(response.studyprogram_name);
            $('#level-modal2').val(response.level);
            $('#accreditation_status-modal2').val(response.accreditation_status);
            $('#national_accreditation-modal2').val(response.national_accreditation);
            $('#national_accrediation_grade-modal2').val(response.national_accrediation_grade);
            $('#date_national_accreditation-modal2').val(response.date_national_accreditation);
            $('#expired_national_accreditation-modal2').val(response.expired_national_accreditation);
            $('#international_accreditaton-modal2').val(response.international_accreditaton);
            $('#international_accrediation_grade-modal2').val(response.international_accrediation_grade);
            $('#date_international_accreditation-modal2').val(response.date_international_accreditation);
            $('#expired_international_accreditation-modal2').val(response
              .expired_international_accreditation);
